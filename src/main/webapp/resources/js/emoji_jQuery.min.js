!function(e){
    ...
    n.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStribject.defineProperty(e,"__esModule",{value:!0})},
    n.t=function(e,t){if(1&t&&(e=n(e)),8&t)
        return e;
    if(4&t&&"object"==typeof e&&e&&e.__esModule)
        return e;
    var o=Object.create(null);
        if(n.r(o),Object.defineProperty(o,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)
            for(var i in e)n.d(o,i,function(t){return e[t]}.bind(null,i));return o},
        n.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};
            return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},
        n.p="",n(n.s=0)}([function(e,t,n){!function(e,t,o){n(1);
        const i=n(6),r=n(7),a=n(8),s=n(9);e.extend({Lemoji:function(n) {if(n&&(!n||"object"!=typeof n))return this;
        var c=e.extend({},{before:function(){},after:function(){},emojiInput:"input",
            emojiBtn:".emojiBtn",position:"LEFTBOTTOM",length:7,
            emojis:{qq:{path:"resources/images/qq",code:":",name:"QQ表情"},
                tieba:{path:"resources/images/tieba",code:";",name:"贴吧表情"},
                emoji:{path:"resources/images/emoji",code:",",name:"Emoji表情"}},
            showBabar:!0},n),l=r(c.emojis,i,c.length),f=e("<div class='emoji_container'>"),
            u=e("<div class='emoji_content'>"),
            p=e("<div class='emoji_tabar' style='display: "+(c.showBabar?"":"none")+";'>"),d="",
            h=0;e.map(c.emojis,function(e,t){d+='<li data-index="'+h+'">'+e.name+"</li>",h++}),
                p.append("<ul>"+d+"</ul>"),f.append(u.append(l)).append(p).appendTo("body"),
                u.on("click","li",function(){var t=e(this).attr("data-code"),n=e(this).attr("title"),
                    o="";switch(t){case":":case";":case",":o="["+t+n+"]",a(e(c.emojiInput),o)}}),
                p.on("click","li",function(){var n=467;e(t).width()<n&&(n=e(t).width());
                var o=e(this).attr("data-index"),i=-n*parseInt(o);i+="px",u.css({marginLeft:i})});
            var m=!0;e(c.emojiBtn).on("click",function(t) {m?(f.show("slow",function(){s(f,e(c.emojiBtn),c.position)}),
                s(f,e(c.emojiBtn),c.position),t.stopPropagation(),m=!1):
                (f.hide("slow"),m=!0)}),e(o).on("click",function(t){if(!m)
                {if("emoji_tabar"==e(t.target).parent().parent().attr("class"))
                    return void t.stopPropagation();
                m=!0,f.hide("slow")}})},emojiParse:function(t)
        {if(t&&(!t||"object"!=typeof t))return this;
        var n=e.extend({},
            {content:"",emojis:[{path:"resources/images/qq",code:":",type:"qq"},
                    {path:"static/images/tieba",code:";",type:"tieba"},
                    {path:"static/images/emoji",code:",",type:"emoji"}]},t),
            o=e.trim(n.content)?n.content:"";if(!o)return o;for(let e=0;e<n.emojis.length;e++)
                o=a(o,n.emojis[e].code,n.emojis[e].path,n.emojis[e].type);
            function r(t,n){var o;return e.map(i[n],function(e,n){e===t&&(o=n)}),o}
            function a(e,t,n,o){var i=new RegExp("\\[\\"+t+"[\\u4e00-\\u9fa5]+\\]","g"),a=e.match(i);
            if(a)for(var s=new RegExp("^\\[\\"+t),c=/\]$/,l=0;l<a.length;l++)
            {var f,u=a[l].replace(s,"");
                if(void 0!=(f=r(u=u.replace(c,""),o)))
                {var p=n+f+".png";e=e.replace(a[l],'<img src="'+p+'" border="0"  width="25" height="25">')}}return e}return o}})}
                (window.jQuery,window,document)},
    function(e,t,n){var o=n(2);"string"==typeof o&&(o=[[e.i,o,""]]);n(4)(o,{hmr:!0,transform:void 0,insertInto:void 0}), o.locals&&(e.exports=o.locals)},
