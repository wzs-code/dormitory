...
<body background="<c:url value="/resources/images/1.jpg"/> ">
<div class="wrapper">
    <div class="banner">
        <h1>简易聊天室:)</h1>
        <button onclick="window.location.href='dorm'" style="float: right;width:70px;height:30px;margin-right:30px;margin-top:20px;background-color: #42cde2">退出</button>
    ...
    <div class="controls">
        <div class="items">
            ...
            <form id="sendImageForm" enctype="multipart/form-data" method="post">
                ...
                <input id="myName" type="hidden" name="userName" value="${user.username}">
            </form>
        </div>
...
<!-- chatroom css样式文件 -->
<link rel="stylesheet" href="<c:url value="/resources/css/chatroom.css?v=20172102086"/> ">
